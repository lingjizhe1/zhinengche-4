...
./user/cpu1_main.src \
./user/isr.src \
./user/motor_servo_contrl.src 

C_DEPS += \
./user/cpu0_main.d \
./user/cpu1_main.d \
./user/isr.d \
./user/motor_servo_contrl.d 

OBJS += \
./user/cpu0_main.o \
./user/cpu1_main.o \
./user/isr.o \
./user/motor_servo_contrl.o 
...
clean-user:
	-$(RM) ./user/cpu0_main.d ./user/cpu0_main.o ./user/cpu0_main.src ./user/cpu1_main.d ./user/cpu1_main.o ./user/cpu1_main.src ./user/isr.d ./user/isr.o ./user/isr.src ./user/motor_servo_contrl.d ./user/motor_servo_contrl.o ./user/motor_servo_contrl.src
